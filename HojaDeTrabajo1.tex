...
\multirow{5}{*}{\includegraphics[width=2cm]{recursos/logo.png}}
 ...
 & Informática 1 \\
 & Henry Santiago Vásquez Alvizures \\
 & ID: 20181106 \\
\end{tabular}
...
\begin{enumerate}
	...
	{\bf Respuesta:} $\{1, 2, 3, 4, 5, 6\}$
 	...
 	\item{El conjunto de vértices del grafo} \\
	{\bf Respuesta:} \\
...
\begin{enumerate}
    ...
    \item{¿Como nos aseguramos que ese algoritmo siempre produce un resultado?}\\
    	{\bf Respuesta:} Para la determinación del camino más corto, dado un vértice origen, hacia el resto de los vértices en un grafo, se deben explorar todos los caminos más cortos que parten del vertice de origen y que llevan a todos los demás vértices; cuando 						 se obtiene el camino más corto desde el vértice origen hasta el resto de los 								 vértices que componen el grafo, el algoritmo se detiene, logrando asi descartar 							 ciclos. Por ello el Algoritmo de caminos siempre produce un resultado.
\end{enumerate}
